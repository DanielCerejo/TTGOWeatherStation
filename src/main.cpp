...
const char *ssid = "name wifi";         /// EDIIIT
const char *password = "password wifi"; // EDI8IT
String town = "Coimbra";                // EDDIT
...
void setupWiFI()
{
  ...
  // GMT -1 = -3600
  // GMT 0 = 0
  timeClient.setTimeOffset(1 * 3600); /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
  getData();
}
